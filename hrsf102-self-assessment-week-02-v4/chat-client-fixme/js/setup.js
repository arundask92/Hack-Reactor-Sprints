...
$.ajaxPrefilter(function(settings, _, jqXHR) {
  jqXHR.setRequestHeader(
    ...
    "5ec0221ee8b439a1fc8fdfd6a638b3e6af1cb1b4"
  );
  jqXHR.setRequestHeader(
    "X-Parse-REST-API-Key",
    "bbfaf2b05152043f1b8207ba13c600d4bf296795"
  );
});
...
var SERVER_URL =
  "http://parse.shared.hackreactor.com/chatterbox/classes/messages";
...
//I believe this is the method the sends messages to the server due to
//it's type POST
